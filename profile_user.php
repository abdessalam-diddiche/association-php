...
<body>
    ...
    <header id="header">
        <div class="container box_1170 main-menu">
            <div class="row align-items-center justify-content-center d-flex">
                <nav id="nav-menu-container">
                    <ul class="nav-menu">
                        <li class="menu-active"><a href="profile_user.php">Home</a></li>
	   ...
	   ?>
						...
						<li><a href="logout.php"><span class="lnr lnr-user"></span> Logout</a></li>                    </ul>
                </nav>
            </div>
        </div>
            ...
            <div class="row d-flex align-items-center justify-content-center">
                <div class="about-content col-lg-12">
                    ...
                    <p class="text-white link-nav"><a href="index.html">Home </a> <span class="lnr lnr-arrow-right"></span>
                        ...
                        <a href="article.php"> Articles</a></p>
                </div>
            </div>
        </div>
    </section>
					...
					<div class="owl-carousel active-stories-carousel">
						...
						<div class="single-stories-carousel d-flex align-items-center">
							...
							<div class="stories-details">
								<h6><a href="profile.php">Ajouter des Articles</a></h6>
							</div>
						</div>
						<!-- single stories carousel -->
						<div class="single-stories-carousel d-flex align-items-center">
							...
							<div class="stories-details">
								<h6><a href="article.php">Voir tous les articles</a></h6>
							</div>
						</div>
						<!-- single stories carousel -->
						<div class="single-stories-carousel d-flex align-items-center">
							...
							<div class="stories-details">
								<h6><a href="">2nd Gen Smoke Alarm</a></h6>
							</div>
						</div>
						<!-- single stories carousel -->
						<div class="single-stories-carousel d-flex align-items-center">
    ...
    <section class="blog_area section-gap single-post-area">
        <div class="container box_1170">
            <div class="row">
				...
				<form method="POST" action="profile_session.php">
					<button class="btn btn-light" type="submit" name="signin"><span class="lnr lnr-exit"></span>Ajouter une article</button>
					...
					<div class="single-widget protfolio-widget">
                        ...
                        if(mysqli_num_rows($result) > 0){
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                $sqlimage = "SELECT * FROM profileimage WHERE id = '$id' ";
...
if(isset($_SESSION['id_utilisateur'])){
    if($_SESSION['id_utilisateur'] == 25){
          echo "You are logged";
    }echo "<form class='md-form' action='upload.php' method='POST' enctype='multipart/form-data'>
          <span>Add photo</span>
          <input type='file' name='file'>
        <button type='submit' class='btn btn-mdb-color btn-rounded float-right' name='submit'>UPLOAD</button>
  </form>";
}
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">Abdessalam</a>
