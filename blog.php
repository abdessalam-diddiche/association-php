	...
	<header id="header">
	   ...
	   ?>
						...
						<li><a href="contact.html">Contact</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
				<div id="sign">
				<li><a href="signup.php"><span class="lnr lnr-user"></span> Sign Up</a></li>
				<li><a href="login.php"><span class="lnr lnr-exit"></span> Sign In</a></li>

				<!-- <form method="POST" action="login_user.php">
					<button class="btn btn-light" type="submit" name="signin"><span class="lnr lnr-exit"></span>Sign in</button>
			...
			<div class="row">
				...
				<div class="col-lg-4 sidebar">
					<div class="single-widget protfolio-widget">
						<img class="img-fluid" src="img/blog/abdo2.jpg" alt="">
						<a href="#">
